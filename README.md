...
(`src/Modules/`). Сама студия собрана из модулей: дизайнер форм — модуль
`ArxisStudio.Modules.Designer`, и поднимается он тем же SDK-контрактом, что и
внешний плагин, — оболочка не знает ни одного формата документов.
