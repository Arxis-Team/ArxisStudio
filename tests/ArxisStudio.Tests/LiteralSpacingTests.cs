...
public class LiteralSpacingTests
{
    ...
    /// </summary>
    /// <remarks>
    /// Ни одного. Последним было место палитры команд — восемьдесят точек от верхнего края окна, —
    /// и оно уехало в тему ключом вместе с её шириной: карточка палитры такой же потребитель
    /// вёрстки экрана, как окно приветствия или настройки. Правило то же, что у разметки:
    /// опускается коммитом, который число убрал, и не поднимается ничем.
    /// </remarks>
