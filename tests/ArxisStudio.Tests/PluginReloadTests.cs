...
public class PluginReloadTests : IDisposable
{
    ...
    public void Reloading_raises_a_fresh_copy()
    {
        ...
        //
        // Списком, а не по именам: поимённое перечисление знало ровно одну
        // команду примера и молча переставало работать, когда у примера
        // появилась вторая. Падал при этом не пример, а выгрузка — в тесте,
        // который про команды ничего не утверждает.
        commands.Remove([.. commands.Registered]);
