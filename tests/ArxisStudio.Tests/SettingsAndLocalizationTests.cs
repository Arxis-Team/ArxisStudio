...
public class LocalizerTests
{
    ...
    /// <para>
    /// Разбор здесь строже студийного нарочно. Студия читает словари с
    /// комментариями и висячими запятыми — их правит человек, — а словари поставки
    /// остаются строгим JSON: с шаблона начинают переводчики, и их инструменты
    /// комментариев не знают.
    /// </para>
    /// </remarks>
    [Theory]
