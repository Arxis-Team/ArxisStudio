...
/// </para>
/// <para>
/// Словарём считается любой поданный сборкой файл, кроме самих манифестов: и у
/// плагина, и у модуля это <c>lang/en.json</c> в папке расширения. Имя здесь не
/// написано: расположение словарей — дело того, кто их подаёт, а не проверки.
/// </para>
/// <para>
...
public sealed class ManifestStringsAnalyzer : DiagnosticAnalyzer
{
    ...
    /// </summary>
    /// <remarks>
    /// Словарём считается всё поданное, кроме самих манифестов: и у плагина, и у
    /// модуля это <c>lang/en.json</c> в папке расширения. Имя здесь не написано
    /// нарочно — где лежат словари, решает тот, кто их подаёт.
    /// <para>
