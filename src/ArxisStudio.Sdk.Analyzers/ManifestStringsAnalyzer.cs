...
/// плагина это <c>lang/en.json</c>, у модуля — словарь студии, её строки он и
/// показывает. Ни то, ни другое имя здесь не написано: расположение словарей —
/// дело того, кто их подаёт, а не проверки.
/// </para>
/// <para>
