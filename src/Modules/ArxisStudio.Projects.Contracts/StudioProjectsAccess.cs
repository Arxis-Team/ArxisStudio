...
public static class StudioProjectsAccess
{
    ...
    /// создающему файлы — <c>1.6</c>.
    /// </returns>
    /// <remarks>
    /// Четвёртая служба того же модуля: создаёт, перемещает, копирует и удаляет файлы решения,
    /// переписывая ссылки на них в файлах проектов и записывая каждое действие в локальную историю.
    /// </remarks>
