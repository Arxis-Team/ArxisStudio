...
/// <para>
/// Служб три, и все публикуются экспортом, как у плагина: модель, сборка и пакеты разведены по
/// тому, чем занят берущий, — подписчику снимков события сборки не нужны, а правящему ссылки не
/// нужен снимок. Другой дороги к ним у соседей нет, и у самой студии тоже не будет — работа с
/// проектами проверяется тем путём, каким её получит чужой плагин.
/// </para>
/// </remarks>
