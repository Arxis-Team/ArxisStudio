...
public sealed class StudioPlugins
{
    ...
    /// <summary>Журнал студии — тот, в который служба пишет о расширениях.</summary>
    /// <remarks>
    /// Нужен окну настроек: языки пакетов оно собирает само, и о пакете, чей язык не предлагается,
    /// говорит в тот же журнал, куда о нём сказал бы запуск.
    /// </remarks>
    internal IStudioLog Log => _log;
