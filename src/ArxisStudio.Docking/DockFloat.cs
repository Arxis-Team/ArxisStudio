...
public class DockFloat : AxWindow
{
    ...
    public DockFloat()
    {
        ...
        //
        // Нет и кнопки «свернуть»: окно при студии не заводит себе кнопки в
        // панели задач, и свёрнутое исчезает, не оставив человеку дороги
        // назад. Развернуть окно можно — это обратимо и повторяет двойной
        // щелчок по шапке.
        View = new DockView
        {
            Actions = () => new AxWindowControls { ShowMinimize = false },
            Railed = false,
        };
