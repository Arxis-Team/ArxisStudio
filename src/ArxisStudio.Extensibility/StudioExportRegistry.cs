...
/// <para>
/// Занятый тип второму поставщику не отдаётся — то же правило, что у команд:
/// два хозяина на одно место — это не выбор, а гонка, и выиграл бы тот, кого
/// раньше загрузили. О попытке говорит событие.
/// </para>
/// </remarks>
