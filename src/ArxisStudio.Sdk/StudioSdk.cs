...
public static class StudioSdk
{
    ...
    /// <remarks>
    /// 4.1 — добавлены теги манифеста (<c>tags</c>). Младший номер, потому что
    /// поле добавлено, а не изменено: плагин, написанный под 4.0, поднимается
    /// в этой студии без правок, а тегов у него просто нет.
    /// </remarks>
