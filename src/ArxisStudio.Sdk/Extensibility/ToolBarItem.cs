...
/// подняв плагин, нечем.
/// <para>
/// Полоса невысока — <c>AxTitleBarHeight</c>, сорок пикселей при обычной плотности, — и
/// контрол обязан в неё помещаться: его кнопки тесного размера
/// (<c>Size = AxControlSize.Compact</c>), высотой <c>AxControlHeightCompact</c>. Строить его
/// следует на контролах <c>Ax*</c>: свой контрол стоит в одном ряду с кнопками студии, и
